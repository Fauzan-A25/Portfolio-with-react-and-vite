export const projects = [
  {
    ...
    technologies: ["Python 3.9+", "Streamlit", "Scikit-learn", "Pandas", "NumPy", "Matplotlib"],
    features: ["Real-time water quality prediction", "Interactive parameter input", "Visual data analysis", "Model performance metrics", "User-friendly interface"],
    ...
    featured: "true",
    highlights: ["Achieved 89% accuracy in water potability prediction", "Deployed on Streamlit Cloud for public access", "Processed 3,276 water quality samples"],
  },
  {
    id: 2,
    ...
    technologies: ["Python 3.9+", "XGBoost", "Pandas", "NumPy", "Scikit-learn", "SHAP", "Matplotlib", "Seaborn"],
    features: ["Advanced feature engineering", "XGBoost classification model", "SHAP value analysis for interpretability", "Comprehensive data preprocessing", "Model performance evaluation"],
    ...
    demoUrl: "",
    featured: "true",
    highlights: ["Developed predictive model with 92% accuracy", "Analyzed 10,000+ mobile applications", "Implemented SHAP for model explainability"],
  },
  {
    id: 3,
    ...
    technologies: ["Python 3.9+", "PyTorch", "OpenCV", "NumPy", "Matplotlib", "CUDA"],
    features: ["Accurate crowd density estimation", "Handles sparse and dense scenes", "Real-time inference capability", "Pre-trained model support", "Visualization tools"],
    ...
    demoUrl: "",
    featured: "true",
    highlights: ["Trained on ShanghaiTech dataset", "Achieved MAE of 68.2 on Part A", "Optimized learning rate to 1e-4"],
  },
  {
    id: 4,
    ...
    technologies: ["Python", "Pandas", "Plotly/Matplotlib", "JavaScript", "D3.js", "HTML/CSS"],
    features: ["Interactive climate change visualizations", "Disaster pattern analysis across Pacific regions", "Time-series data exploration", "Geographic heat maps", "Comparative regional statistics", "Responsive dashboard design"],
    ...
    demoUrl: "",
    featured: "true",
    highlights: ["Participated in Pacific Dataviz Challenge competition", "Analyzed climate and disaster data from Pacific Data Hub", "Created compelling visual narratives for Pacific Island climate issues", "Contributed to Blue Pacific 2050 strategy awareness"],
  },
  {
    id: 5,
    ...
    technologies: ["Python 3.x", "Streamlit", "Scikit-learn", "XGBoost", "LightGBM", "Pandas", "NumPy", "Matplotlib"],
    features: ["Upload and process astronomical observation data (CSV)", "Automatic data preprocessing pipeline", "Multiple ML model selection (Random Forest, XGBoost, LightGBM)", "Interactive classification visualizations", "Confusion matrix and classification reports", "Export prediction results", "Real-time celestial object classification"],
    category: "Machine Learning",
    status: "Completed",
    year: 2024,
    duration: "2 months",
  ...
  },
  {
    ...
    tags: ["Financial Literacy", "Data Analytics", "Dashboard", "Gen Z", "Indonesia"],
    technologies: ["React", "TypeScript", "Vite", "Zustand", "Tailwind CSS", "Recharts"],
    features: ["Multi-Page Analytics (Overview, Financial Literacy, Behavior & Well-being, Regional)", "Advanced Filtering by Province, Education, Income, and Age", "Rich Visualizations with KPI Cards, Bar Charts, Scatter Plots, Radar Charts, and Heatmaps", "Data Export to CSV with filtered indicators"],
    category: "Data Visualization",
    status: "Completed",
    year: 2025,
    duration: "1 month",
    ...
    featured: "true",
    highlights: ["Provides deep insights into GenZ's financial literacy across 5 key dimensions.", "Comprehensive filtering options across 38 provinces and various demographics.", "Utilizes rich visualizations for complex data analysis and insights."],
  },
  {
    id: 7,
    ...
    tags: ["Computer Vision", "Deep Learning", "Face Anti-Spoofing", "Liveness Detection", "Biometrics"],
    technologies: ["Python 3.9+", "PyTorch", "OpenCV", "NumPy", "Matplotlib"],
    features: ["Real-time liveness detection", "Presentation attack detection (PAD)", "Spoof vs Real classification", "Face detection and cropping", "Webcam integration for live inference"],
    category: "Computer Vision",
    status: "Completed",
    year: 2025,
    duration: "2 months",
    ...
    demoUrl: "",
    featured: "true",
    highlights: ["Developed robust presentation attack detection model", "Integrated with real-time webcam feed for live inference", "Enhanced biometric security for facial recognition pipelines"],
  },
  {
    id: 9,
    ...
    image: "",
    tags: ["Dart", "Flutter", "Android", "Mobile Development", "Health", "Capstone"],
    technologies: ["Dart", "Flutter", "Android SDK", "Firebase", "Git"],
    features: ["User-friendly interface for tracking daily nutrition and kidney health metrics", "Meal logging and nutrient intake visualization", "Health data monitoring and history display", "Cross-platform mobile app development using Flutter"],
    ...
    demoUrl: "",
    featured: "false",
    highlights: ["Developed a functional Android app for nutrition and kidney health tracking as a capstone project", "Applied Dart and Flutter to create a cross-platform mobile application", "Successfully met academic requirements for Telkom University capstone"],
  },
  {
    id: 10,
    ...
    image: "",
    tags: ["Chatbot", "WhatsApp", "Automation", "JavaScript", "Messaging"],
    technologies: ["JavaScript", "Node.js", "WhatsApp Web API", "puppeteer", "Express.js"],
    features: ["Automated message sending and receiving on WhatsApp", "Predefined response configuration for common queries", "Lightweight and easy to deploy on local or cloud servers", "Basic scheduling for timed messages"],
    category: "Tools",
    status: "Completed",
    year: 2026,
    duration: "2 weeks",
    ...
    demoUrl: "",
    featured: "false",
    highlights: ["Developed a functional WhatsApp chatbot prototype in under two weeks", "Enabled automated messaging without manual intervention", "Created a simple, configurable system for non-technical users"],
  },
  {
    id: 11,
    ...
    image: "",
    tags: ["JavaScript", "Music", "Web Application", "Frontend", "Audio Player"],
    technologies: ["JavaScript", "HTML5", "CSS3", "Web Audio API", "React.js (assumed)"],
    features: ["Browse and search through a collection of melodies", "Create and manage custom playlists", "Built-in audio player with play, pause, and skip controls", "Responsive design for desktop and mobile devices", "Modular code architecture for easy customization"],
    ...
    demoUrl: "",
    featured: "false",
    highlights: ["Developed a functional prototype with core music browsing and playback features", "Implemented responsive UI for seamless use across devices", "Established modular codebase for future scalability and feature additions"],
  },
  {
    id: 12,
    ...
    image: "",
    tags: ["Cryptography", "AES-256", "CBC Mode", "Data Security", "Python"],
    technologies: ["Python 3", "Jupyter Notebook", "pycryptodome", "AES-256", "CBC Mode"],
    features: ["Implements AES-256 encryption with CBC mode for secure data handling", "Provides both encryption and decryption functions in a single notebook", "Outputs ciphertext and decrypted plaintext in hexadecimal format for easy verification", "Well-documented code cells for educational purposes"],
    category: "Academic",
    status: "Completed",
    year: 2025,
    duration: "1 week",
    ...
    demoUrl: "",
    featured: "false",
    highlights: ["Successfully implemented AES-256 CBC encryption as a course assignment", "Demonstrated encryption and decryption processes with sample data", "Provided a clear, educational notebook for learning cryptography"],
  },
  {
    id: 13,
    ...
    image: "",
    tags: ["Portfolio", "React", "Vite", "CSS", "Responsive Design", "Frontend"],
    technologies: ["React 18", "Vite 5", "CSS3", "JavaScript ES6", "HTML5", "Git"],
    features: ["Component-based architecture using React for maintainability", "Fast development and optimized production builds with Vite", "Fully responsive design for desktop and mobile devices", "Clean, customizable CSS styling for personal branding"],
    category: "Web Development",
    status: "Completed",
    year: 2025,
    duration: "2 weeks",
    ...
    demoUrl: "",
    featured: "false",
    highlights: ["Built a fully responsive portfolio website using React and Vite", "Achieved fast load times with Vite's optimized build process", "Created a clean, modular codebase for easy future updates"],
  },
  {
    id: 14,
    ...
    image: "",
    tags: ["Machine Learning", "Classification", "Customer Churn", "Data Science", "Jupyter Notebook"],
    technologies: ["Python 3.x", "Jupyter Notebook", "Pandas", "Scikit-learn", "Matplotlib", "Seaborn", "NumPy"],
    features: ["Comprehensive exploratory data analysis with visualizations", "Feature engineering for improved model performance", "Multiple classification models for comparison", "Model evaluation with key metrics like accuracy and ROC-AUC"],
    category: "Data Science",
    status: "Completed",
    year: 2025,
    duration: "2 months",
    ...
    demoUrl: "",
    featured: "false",
    highlights: ["Achieved 85% accuracy in predicting customer churn", "Developed feature engineering that improved recall by 10%", "Delivered actionable insights through clear visualizations"],
  },
  {
    id: 15,
    ...
    image: "",
    tags: ["Data Analysis", "Jupyter Notebook", "Python", "EDA", "Collaborative Learning"],
    technologies: ["Python", "Jupyter Notebook", "pandas", "matplotlib", "seaborn", "numpy"],
    features: ["Comprehensive exploratory data analysis (EDA)", "Data cleaning and preprocessing", "Visualization of key trends and patterns", "Reproducible analysis in Jupyter Notebook"],
    category: "Academic",
    status: "Completed",
    year: 2025,
    duration: "1 week",
    ...
    demoUrl: "",
    featured: "false",
    highlights: ["Completed a structured data analysis assignment as part of a study group", "Applied data cleaning and visualization techniques to extract meaningful insights", "Collaborated effectively with team members to deliver a reproducible analysis"],
  },
  {
    id: 16,
    ...
    image: "",
    tags: ["Python", "Discord Bot", "AI", "Ollama", "DeepSeek", "Chatbot"],
    technologies: ["Python 3.10+", "discord.py", "Ollama", "DeepSeek Model", "REST API", "asyncio"],
    features: ["Integrates Ollama-hosted DeepSeek model for AI responses", "Listens to Discord commands and messages in real-time", "Lightweight and easy to deploy on local or cloud servers", "Customizable prompt handling for different use cases"],
    category: "Tools",
    status: "In Progress",
    year: 2025,
    duration: "2 months",
    ...
    demoUrl: "",
    featured: "false",
    highlights: ["Successfully integrated local AI model (DeepSeek) into Discord platform", "Built a functional bot with low latency response times", "Created reusable codebase for future AI bot projects"],
  },
  {
    id: 17,
    ...
    image: "",
    tags: ["Python", "Machine Learning", "Jupyter Notebook", "GDGOC", "Assignment"],
    technologies: ["Python 3", "Jupyter Notebook"],
    features: ["Covers fundamental Python programming concepts for machine learning", "Includes practical coding exercises with real-world data scenarios", "Demonstrates use of Python libraries for data manipulation", "Structured as an educational assignment for study group collaboration"],
    category: "Academic",
    status: "Completed",
    year: 2025,
    duration: "1 week",
    ...
    demoUrl: "",
    featured: "false",
    highlights: ["Completed as part of GDGOC Telkom University study group curriculum", "Demonstrated proficiency in Python programming fundamentals", "Prepared foundation for advanced machine learning topics"],
  },
  {
    id: 18,
    ...
    image: "",
    tags: ["Jupyter Notebook", "Finance", "Random Walk", "Stock Analysis", "Time Series", "Statistical Modeling"],
    technologies: ["Jupyter Notebook", "Python", "Pandas", "NumPy", "Matplotlib", "SciPy"],
    features: ["Implementation of random walk model for stock price simulation", "Statistical tests (e.g., runs test, autocorrelation) to evaluate randomness", "Visualization of actual vs. simulated price paths", "Comparison across property and raw material stock sectors"],
    category: "Data Science",
    status: "Completed",
    year: 2025,
    duration: "1 week",
    ...
    demoUrl: "",
    featured: "false",
    highlights: ["Applied random walk theory to real-world stock data from property and raw material sectors", "Performed statistical tests to assess market efficiency hypothesis", "Generated clear visualizations comparing actual and simulated price movements"],
  },
  {
    id: 19,
    ...
    image: "",
    tags: ["Data Analysis", "Jupyter Notebook", "Python", "Machine Learning", "Academic Project"],
    technologies: ["Python 3.x", "Jupyter Notebook", "Pandas", "NumPy", "Scikit-learn", "Matplotlib", "Seaborn"],
    features: ["End-to-end data analysis pipeline in Jupyter Notebook", "Data cleaning and preprocessing steps", "Exploratory data analysis with visualizations", "Implementation of machine learning models for prediction or classification", "Comprehensive documentation of methodology and results"],
    category: "Academic",
    status: "Completed",
    year: 2024,
    duration: "1 semester",
    ...
    demoUrl: "",
    featured: "false",
    highlights: ["Completed as the final project for the AKA course", "Demonstrated proficiency in data analysis and machine learning", "Produced a well-documented Jupyter Notebook with reproducible analysis"],
  },
  {
    id: 20,
    ...
    image: "",
    tags: ["C++", "Data Structures", "Text Editor", "Academic", "Console Application"],
    technologies: ["C++", "Standard Template Library (STL)", "Linked Lists", "Stacks", "Doubly Linked List"],
    features: ["Text insertion and deletion at any position", "Undo/redo functionality using stack data structure", "Efficient text navigation and display", "Modular code structure for educational clarity"],
    category: "Academic",
    status: "Completed",
    year: 2024,
    duration: "1 semester",
    ...
    demoUrl: "",
    featured: "false",
    highlights: ["Applied doubly linked list for efficient O(1) text insertion/deletion", "Implemented undo/redo using two stacks for action reversal", "Successfully completed as a data structures course assignment"],
  },
  {
    id: 21,
    ...
    image: "",
    tags: ["HTML", "CSS", "Bootstrap 5", "Web Development", "Portfolio", "Responsive Design"],
    technologies: ["HTML5", "CSS3", "Bootstrap 5", "Responsive Web Design"],
    features: ["Responsive layout using Bootstrap 5 grid system for optimal viewing on all devices", "Dedicated sections for About Me, Skills, Projects, and Contact", "Modern and clean visual design with Bootstrap components and custom CSS", "Easy to update and maintain structure for adding new projects or information"],
    category: "Web Development",
    status: "Completed",
    year: 2024,
    duration: "2 weeks",
    ...
    demoUrl: "",
    featured: "false",
    highlights: ["Built a fully responsive portfolio in under two weeks using Bootstrap 5", "Designed and implemented four distinct sections (About, Skills, Projects, Contact) for comprehensive personal branding", "Achieved a clean, modern aesthetic without external design frameworks beyond Bootstrap"],
  },
  {
    id: 22,
    ...
    image: "",
    tags: ["Machine Learning", "Education", "Classification", "Regression", "Python"],
    technologies: ["Python", "Jupyter Notebook", "pandas", "scikit-learn", "matplotlib", "seaborn"],
    features: ["Comprehensive data cleaning and preprocessing of student records", "Exploratory data analysis with visualizations of key factors", "Implementation of multiple ML models with hyperparameter tuning", "Performance evaluation using MAE and accuracy metrics"],
    category: "Data Science",
    status: "Completed",
    year: 2024,
    duration: "2 months",
    ...
    demoUrl: "",
    featured: "false",
    highlights: ["Built predictive models achieving over 85% accuracy on test data", "Identified key features influencing academic performance through EDA", "Developed a reproducible pipeline for educational data analysis"],
  },
  {
    id: 23,
    ...
    image: "",
    tags: ["discord", "discord-bot", "discord-js", "music", "nodejs", "audio-streaming"],
    technologies: ["Node.js", "discord.js v14", "yt-dlp", "JavaScript", "npm", "Git"],
    features: ["High-quality audio streaming from YouTube", "Queue management with add, remove, skip, and clear functions", "Multiple loop modes: track, queue, and off", "Shuffle playback for randomized song order", "Volume control and automatic playback of next track"],
    category: "Tools",
    status: "Completed",
    year: 2024,
    duration: "2 months",
    ...
    demoUrl: "",
    featured: "false",
    highlights: ["Developed a full-featured Discord music bot with zero external dependencies for streaming", "Implemented robust queue management and multiple loop modes for enhanced user control", "Achieved reliable audio streaming with low latency using yt-dlp integration"],
  },
  {
    id: 24,
    ...
    image: "",
    tags: ["Go", "Library Management", "Data Structures", "Algorithms", "Backend"],
    technologies: ["Go 1.21", "Standard Library", "File I/O", "Linked Lists", "Hash Maps", "Sorting Algorithms"],
    features: ["Add, update, and delete books with details like title, author, and ISBN", "Register and manage library members with contact information", "Check out and return books with automatic due date calculation", "Search books by title, author, or genre"],
    category: "Tools",
    status: "Completed",
    year: 2024,
    duration: "1 semester",
    ...
    demoUrl: "",
    featured: "false",
    highlights: ["Implemented core data structures (linked lists, hash maps) to manage 50+ book records efficiently", "Developed sorting algorithms to enable search and listing of books by multiple criteria", "Created a modular codebase with separate packages for books, members, and transactions"],
  },
];
